<%@ Page Title="" Language="C#" MasterPageFile="~/Saftetymain.Master" AutoEventWireup="true" CodeBehind="RootCauseIncident.aspx.cs" Inherits="safetys4.RootCauseIncident" %>
    ...
    */
    ...
    function setPiechart()
    {
        ...
        $.ajax({
            ...
            url: 'Report.asmx/getRootCauseIncident',
            dataType: 'json',
            success: function (json) {
                  ...
                  //  plot1.redraw();
                    ...
                    piechart = jQuery.jqplot('report_piechart',
                        [data],
                        {
                            title: '<b>Root cause of incident by OH&S pyramid</b>',
                            seriesColors: ['#8181F7', '#A9D0F5', '#58FA58', ' #229954', '#F4FA58', '#FFBF00', '#F5A9A9', '#FA5858', '#B40404', '#BDBDBD', '#B404AE', '#FF8000', '#AC58FA', '#FA5882', '#086A87', '#210B61', '#BEF781', '#0174DF', '#fef5e7'],
                            seriesDefaults: {
                                shadow: false,
    ...
    <div class="row">
        <div class="col-md-12">
             <br />
            <div id="report_piechart" style="height:850px;"></div>
