...
namespace safetys4
{
    public partial class dropzoneuploadactionsot : System.Web.UI.Page
               ...
               // typefile = arr_name[1];
                ...
                if (file != null && file.ContentLength > 0)
                {
                   ...
                   // string pathfolder = string.Format("{0}\\upload\\hazard\\step3\\" + name_folder, Server.MapPath(@"\"));
                    string pathfolder = string.Format("{0}" + pathupload + "sot\\" + country +"\\action\\"+ name_folder, Server.MapPath(@"\"));
