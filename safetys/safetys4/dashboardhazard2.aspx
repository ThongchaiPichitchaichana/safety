<%@ Page Title="" Language="C#" MasterPageFile="~/Saftetymain.Master" AutoEventWireup="true" CodeBehind="dashboardhazard2.aspx.cs" Inherits="safetys4.dashboardhazard2" %>
...
<%--        <%
    ...
    function setDashboardFormOneToTwo(area_id)
    {
        ...
        $.ajax({
            ...
            url: 'Dashboard.asmx/getDashboardHazardFormOneToTwo',
            dataType: 'json',
            success: function (json) {
                ...
                if (json.redirect == "")
                {
                    ...
                    plot1 = $.jqplot('dashboard', [data1], {
                        ...
                        title: '<b>Number of pending reports form 1-2 (verify hazard report)</b>',
                        seriesColors: ['#00749F'],
    ...
    function setDashboardFormTwoToThree(area_id)
    {
        ...
        $.ajax({
            ...
            url: 'Dashboard.asmx/getDashboardHazardFormTwoToThree',
            dataType: 'json',
            success: function (json) {
                ...
                if (json.redirect == "")
                {
                    ...
                    plot2 = $.jqplot('dashboard2', [data1], {
                        // Only animate if we're not using excanvas (not in IE 7 or IE 8)..
                        title: '<b>Number of pending reports form 2-3 (process of action) </b>',
                        seriesColors: ['#cb4335'],
                        animate: !$.jqplot.use_excanvas,
    ...
    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            <li class=""><a href="dashboardhazard.aspx" aria-expanded="true">1</a></li>
                            
                            <li class="active"><a  href="dashboardhazard2.aspx" aria-expanded="false">Pending Work</a></li>
                        </ul>
