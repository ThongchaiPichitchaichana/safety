<%@ Page Title="" Language="C#" MasterPageFile="~/Saftetymain.Master" AutoEventWireup="true" CodeBehind="TIFRSrilankaReport.aspx.cs" Inherits="safetys4.TIFRSrilankaReport" %>
 ...
 $(document).ready(function () {
    ...
    function searchTable()
    {
        ...
        $.ajax({
            ...
            url: 'Report.asmx/getListTIFREmployeeReportSrilanka',
            dataType: 'json',
        ...
        $.ajax({
            ...
            url: 'Report.asmx/getListTIFRContractorOnsiteReportSrilanka',
            dataType: 'json',
            success: function (json) {
        ...
        $.ajax({
            ...
            url: 'Report.asmx/getListTIFRContractorOffsiteReportSrilanka',
            dataType: 'json',
            success: function (json) {
