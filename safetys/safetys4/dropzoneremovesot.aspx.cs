...
namespace safetys4
{
    public partial class dropzoneremovesot : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string pathfile = string.Format("{0}" + pathupload + "sot\\" + Session["country"].ToString() + "\\" + folder + "\\" + name, Server.MapPath(@"\"));
