...
namespace safetys4 {
    ...
    public class HazardExport : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "safetys4.HazardExport.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedHazardExport : Component, ICachedReport {
        
        public CachedHazardExport() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            HazardExport rpt = new HazardExport();
            rpt.Site = this.Site;
            return rpt;
        }
