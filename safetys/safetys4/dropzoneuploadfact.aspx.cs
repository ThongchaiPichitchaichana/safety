...
namespace safetys4
{
    public partial class dropzoneuploadfact : System.Web.UI.Page
    {
        ...
        public void SaveUploadedFile(HttpFileCollection httpFileCollection)
        {
            ...
            string file_name = "fact_"+ FormatDates.getDateTimeMicro(DateTime.UtcNow.AddHours(Convert.ToDouble(Session["timezone"].ToString())));
