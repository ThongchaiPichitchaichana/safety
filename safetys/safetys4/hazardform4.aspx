<%@ Page Title="" Language="C#" MasterPageFile="~/Saftetymain.Master" AutoEventWireup="true" CodeBehind="hazardform4.aspx.cs" Inherits="safetys4.hazardform4" %>
...
.a-step{
 ...
 <script type="text/javascript">
    ...
    function setDatatable()
    {
        ...
        dataTable.ajax.url('Datatablelist.asmx/getListLogRequestCloseHazard?hazard_id=' + id + "&lang=" + lang );
...
<div class="stepwizard">
      <div class="stepwizard-row setup-panel">
        ...
        <p><%= Resources.Hazard.hazardstep3 %></p>
         ...
         <div class="stepwizard-step">
            <asp:LinkButton ID="step4" runat="server" CssClass="btn btn-primary btn-circle a-step"  CausesValidation="False">4</asp:LinkButton>
                 ...
                 <div class="row">
                    ...
                    <div class="pull-right">
                          ...
                          <%
                              ...
                              bool pa = safetys4.Class.SafetyPermission.checkPermisionAction("report hazard4 edit", id, "hazard", Convert.ToInt32(Session["group_value"]));
                              bool area = safetys4.Class.SafetyPermission.checkPermisionInArea(id, "hazard");

                              if (per.IndexOf("report hazard4 edit") > -1 && pa == true && area == true)         
                           {                            
                    ...
                    <div class="col-md-12">
                          <table id="tbList" class="table table-bordered table-hover">
                             <thead>
                                <tr>
                                    <th></th>
                                    <th> <%= Resources.Hazard.postion %></th>
                                    <th> <%= Resources.Hazard.name_surname %></th>
                                    <th> <%= Resources.Hazard.date %></th>
                                    <th> <%= Resources.Hazard.approval %></th>               
